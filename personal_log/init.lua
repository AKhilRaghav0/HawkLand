...
-----------------------------------------------------------------------------------------------------
-- Craftable item
local craftable_setting = minetest.settings:get_bool("personal_log_craftable_item", true)
...
minetest.register_craftitem("personal_log:book", {
	description = S("Personal Log Book"),
...
local chat_command_priv = minetest.settings:get_bool("personal_log_chat_command_priviledge", true)
