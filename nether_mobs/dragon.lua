...
blacklist = { -- this nodes can't be destroyed by the nether dragon fire --- DOES NOT WORK, DRAGONS BLOW EVERYTHING UP STILL...
	"default:obsidian",
	...
	"nether:portal",
    "technic:blast_resistant_concrete", --added this myself as they fuck everything up
}
...
mobs:register_mob("nether_mobs:dragon", {
	...
	drops = {
		...
		{name = "nether_mobs:dragon_scale", chance = 1, min = 10, max = 20},
	},
	visual = "mesh",
...
mobs:register_mob("nether_mobs:tamed_dragon", {
	...
	drops = {
		...
		{name = "nether_mobs:dragon_scale", chance = 1, min = 1, max = 1},
	},
	visual = "mesh",
	visual_size = {x=20, y=20},
	collisionbox = {-1.3, -1.0, -1.3, 1.3, 1.8, 1.3},
