...
local l_water_level		= minetest.settings:get("water_level") - 2
	...
	mobs:register_mob("xocean:dolphin", {
		...
		attack_npcs = false,
		damage = 8,
		visual_size = {x = 12, y = 12, z= 12},
		reach = 3,
		hp_min = 30,
		hp_max = 50,
		armor = 100,
		collisionbox = {-1.5, -0.5, -1.5, 1.5, 0.75, 1.5},
		visual = "mesh",
		mesh = "dolphin.b3d",
		textures = {
			{"mobs_dolphin.png"}
	...
	mobs:spawn_specific("xocean:dolphin",	{"default:water_source"},	{"default:water_flowing","default:water_source"},	5, 20, 60, 10000, 2, -31000, l_water_level)
...
mobs:register_mob("xocean:fish", {
	...
	mobs:spawn_specific("xocean:fish",	{"default:water_source"},	{"default:water_flowing","default:water_source"},	2, 20, 60, 10000, 5, -31000, l_water_level)
...
mobs:register_mob("xocean:fish2", {
	...
	mobs:spawn_specific("xocean:fish2",	{"default:water_source"},	{"default:water_flowing","default:water_source"},	2, 20, 60, 10000, 5, -31000, l_water_level)
...
mobs:register_mob("xocean:fish3", {
	...
	mobs:spawn_specific("xocean:fish3",	{"default:water_source"},	{"default:water_flowing","default:water_source"},	2, 20, 60, 10000, 5, -31000, l_water_level)
...
mobs:register_mob("xocean:fish4", {
	...
	mobs:spawn_specific("xocean:fish4",	{"default:water_source"},	{"default:water_flowing","default:water_source"},	2, 20, 60, 10000, 5, -31000, l_water_level)
	mobs:register_egg("xocean:fish4", "Tropical Fish (Snapper)", "xocean_fish4.png", 0)


-- Buzzie's addons for more sealife, taken from mobs_fish/mobs_jellyfish and other sources, using xocean's coding approach instead for spawning.

mobs:register_mob("xocean:jellyfish", {
	...
	hp_max = 10,
	armor = 100,
	collisionbox = {-0.25, -0.5, -0.25, 0.25, 0.75, 0.25},
	visual = "mesh",
	mesh = "jellyfish.b3d",
	textures = {
		{"jellyfish.png"},
	...
	on_rightclick = function(self, clicker)
		mobs:capture_mob(self, clicker, 80, 100, 0, true, "xocean:jellyfish")
	end
	})

	mobs:spawn_specific("xocean:jellyfish",	{"default:water_source"},	{"default:water_flowing","default:water_source"},	2, 20, 60, 10000, 5, -31000, l_water_level)
	mobs:register_egg("xocean:jellyfish", "Mobs Jellyfish merged with xocean mod", "jellyfish_inv.png", 0)
