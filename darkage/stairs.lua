if minetest.get_modpath("moreblox") then
...
elseif minetest.get_modpath("stairs") then
	...
	stairs.register_stair_and_slab("darkage_basalt", "darkage:basalt",
		{cracky=3},
		{"darkage_basalt.png"},
		"Basalt Stair",
		"Basalt Slab",
	...
	stairs.register_stair_and_slab("darkage_marble", "darkage:marble",
		{cracky=3},
		{"darkage_marble.png"},
		"Marble Stair",
		"Marble Slab",
	...
	stairs.register_stair_and_slab("darkage_marble", "darkage:serpentine",
		{cracky=3},
	...
	stairs.register_stair_and_slab("darkage_ors", "darkage:ors",
		{crumbly=2,cracky=2},
		{"darkage_ors.png"},
	...
	stairs.register_stair_and_slab("darkage_schist", "darkage:schist",
		{cracky=3},
		{"darkage_schist.png"},
		"Schist Stair",
		"Schist Slab",
	...
	stairs.register_stair_and_slab("darkage_slate", "darkage:slate",
		{cracky=2},
		{"darkage_slate.png"},
		"Slate Stair",
		"Slate Slab",
	...
	stairs.register_stair_and_slab("darkage_gneiss", "darkage:gneiss",
		{cracky=3},
		{"darkage_gneiss.png"},
		"Gneiss Stair",
		"Gneiss Slab",
	...
	stairs.register_stair_and_slab("darkage_chalk", "darkage:chalk",
		{crumbly=2,cracky=2},
		{"darkage_chalk.png"},
		"Chalk Stair",
		"Chalk Slab",
	...
	stairs.register_stair_and_slab("darkage_slate_cobble", "darkage:slate_cobble",
		{cracky=2},
	...
	stairs.register_stair_and_slab("darkage_slate_brick", "darkage:slate_brick",
		{cracky=2},
	...
	stairs.register_stair_and_slab("darkage_ors_cobble", "darkage:ors_cobble",
		{crumbly=2,cracky=2},
	...
	stairs.register_stair_and_slab("darkage_ors_brick", "darkage:ors_brick",
		{crumbly=2,cracky=2},
	...
	stairs.register_stair_and_slab("darkage_gneiss_cobble", "darkage:gneiss_cobble",
		{crumbly=2,cracky=2},
	...
	stairs.register_stair_and_slab("darkage_gneiss_brick", "darkage:gneiss_brick",
		{crumbly=2,cracky=2},
	...
	stairs.register_stair_and_slab("darkage_basalt_cobble", "darkage:basalt_cobble",
		{cracky=3},
	...
	stairs.register_stair_and_slab("darkage_basalt_brick", "darkage:basalt_brick",
		{cracky=3},
	...
	stairs.register_stair_and_slab("darkage_straw", "darkage:straw",
	...
	stairs.register_stair_and_slab("darkage_straw_bale", "darkage:straw_bale",
	...
	stairs.register_stair_and_slab("darkage_slate_tile", "darkage:slate_tile",
		{cracky=2},
	...
	stairs.register_stair_and_slab("darkage_marble_tile", "darkage:marble_tile",
		{cracky=2},
	...
	stairs.register_stair_and_slab("darkage_stone_brick", "darkage:stone_brick",
		{cracky=3},
	...
	stairs.register_stair_and_slab("darkage_reinforced_chalk", "darkage:reinforced_chalk",
		{cracky=3},
...
--	stairs.register_stair_and_slab("darkage_glass", "darkage:glass",
...
--	stairs.register_stair_and_slab("darkage_glow_glass", "darkage:glow_glass",
--		{snappy=2,cracky=3,oddly_breakable_by_hand=3},
--		{"darkage_glass.png"},
...
--	)
	...
	stairs.register_stair_and_slab("darkage_reinforced_wood", "darkage:reinforced_wood",
