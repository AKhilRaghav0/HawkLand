...
minetest.register_node("nether:sand", {
	...
	is_ground_content = true,
	drop = "default:sand",
	groups = {crumbly = 3, level = 2, falling_node = 0},
...
stairs.register_stair_and_slab( -- this function also registers inner and outer stairs
	"nether_glowstone",                                    -- subname
	"nether:glowstone",                                    -- recipeitem
	{cracky = 2, level = 2},                                -- groups
	{"nether_glowstone.png"},                              -- images
	S("Glowstone Stair"),                                 -- desc_stair
	S("Glowstone Slab"),                                  -- desc_slab
	minetest.registered_nodes["nether:brick_deep"].sounds,  -- sounds
	false,                                                  -- worldaligntex
	S("Inner Glowstone Stair"),                           -- desc_stair_inner
	S("Outer Glowstone Stair")                            -- desc_stair_outer
)
stairs.register_stair_and_slab( -- this function also registers inner and outer stairs
	"nether_glowstone_deep",                                    -- subname
	"nether:glowstone_deep",                                    -- recipeitem
	{cracky = 2, level = 2},                                -- groups
	{"nether_glowstone_deep.png"},                              -- images
	S("Deep Glowstone Stair"),                                 -- desc_stair
	S("Deep Glowstone Slab"),                                  -- desc_slab
	minetest.registered_nodes["nether:brick_deep"].sounds,  -- sounds
	false,                                                  -- worldaligntex
	S("Inner Deep Glowstone Stair"),                           -- desc_stair_inner
	S("Outer Deep Glowstone Stair")                            -- desc_stair_outer
)
