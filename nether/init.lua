...
-- Settings
nether.DEPTH_CEILING              =  -8000 -- The y location of the Nether's celing
nether.DEPTH_FLOOR                = -9000 -- The y location of the Nether's floor
...
nether.PORTAL_BOOK_LOOT_WEIGHTING =    0 -- Likelyhood of finding the Book of Portals (guide) in dungeon chests. Set to 0 to disable.
