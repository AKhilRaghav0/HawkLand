...
mymillwork.register("ethereal:blue_marble",
    "blue_marble",
    "Blue Marble",
    "ethereal_blue_marble.png",
    {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, wood = 1, not_in_creative_inventory = nici}
)
mymillwork.register("ethereal:blue_marble_tile",
    "blue_marble_tile",
    "Blue Marble Tile",
...
-- streets_asphalt_black blue red yellow

mymillwork.register("roadnodes:asphalt_black",
    "asphalt_black",
    "asphalt black",
    "streets_asphalt_black.png",
    {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, not_in_creative_inventory = nici}
)

mymillwork.register("roadnodes:asphalt_blue",
    "asphalt_blue",
    "asphalt blue",
    "streets_asphalt_blue.png",
    {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, not_in_creative_inventory = nici}
)

mymillwork.register("roadnodes:asphalt_red",
    "asphalt_red",
    "asphalt red",
    "streets_asphalt_red.png",
    {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, not_in_creative_inventory = nici}
)

mymillwork.register("roadnodes:asphalt_yellow",
    "asphalt_yellow",
    "asphalt yellow",
    "streets_asphalt_yellow.png",
    {choppy = 2, oddly_breakable_by_hand = 2, flammable = 2, not_in_creative_inventory = nici}
)
